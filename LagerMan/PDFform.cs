...
namespace LagerMan
{
    class PDFform
    {
        ...
        /// </summary>
        public Document CreateDocument(Int64 LagermanId, string customer, string street, string postcode, string city)
        {
            // Create a new MigraDoc document
            this.document = new Document();
            this.document.Info.Title = "";
            this.document.Info.Subject = "";
            this.document.Info.Author = "LagerMan - Using Migradoc";

            DefineStyles();

            CreatePage(LagermanId);

            FillContent(customer, street, postcode, city);
        ...
        void CreatePage(Int64 LagermanId)
        {
           ...
           Image image= section.AddImage(path);
            ...
            paragraph.AddText("Solcelle Specialisten.");
            ...
            paragraph = this.addressFrame.AddParagraph("lagerman nr.:" + LagermanId.ToString());
        ...
        /// </summary>
        void FillContent(string customer, string street, string postcode, string city)
        {
            ...
            paragraph.AddText("Hvis der er afvigelse så kontakt os venligst omgående");
